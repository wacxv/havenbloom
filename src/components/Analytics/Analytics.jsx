...
const demoAnalyticsUser = { _id: 'demo-patient', role: 'patient', first_name: 'Elena', last_name: 'Carter', email: 'elena.carter@example.com' };

const Analytics = () => {
  const navigate = useNavigate();
  const [user, setUser] = useState(demoAnalyticsUser);
  ...
  const [currentFetalHeartRate, setCurrentFetalHeartRate] = useState(142);
  ...
  const generatePlaceholderData = () => {
    ...
    setHeartRateData({
      ...
      datasets: [
        {
          label: 'Heart Rate',
          data: [72, 76, 80, 78, 81, 79, 77, 78, 80],
          borderColor: '#D67AB1',
          backgroundColor: 'rgba(214, 122, 177, 0.2)',
          fill: true,
          tension: 0.4,
    ...
    setFetalHeartRateData({
      ...
      datasets: [
        {
          label: 'Fetal Heart Rate',
          data: [138, 141, 143, 142, 144, 140, 142, 143, 142],
          borderColor: '#D67AB1',
          backgroundColor: 'rgba(214, 122, 177, 0.2)',
          fill: true,
          tension: 0.4,
