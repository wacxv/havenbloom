        ...
        <div className="role-modal-overlay">
            <div className="role-modal">
                ...
                <div className="role-modal-buttons">
                    <button className="role-modal-btn" onClick={() => onSelect('patient')}>Patient</button>
                    <button className="role-modal-btn" onClick={() => onSelect('doctor')}>Doctor</button>
                </div>
            </div>
        </div>
    );
...
const SignIn = () => {
    ...
    const [showRoleModal, setShowRoleModal] = useState(true); // Show modal on mount
    ...
    const handleChange = (e) => {
        ...
        // Clear general error when user is typing
        setError(null);
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!user || user.role !== 'patient') {
                setError('Only patients can sign in on this page.');
                setLoading(false);
                return;
            }
    ...
    const handleRoleSelect = (role) => {
        ...
        if (role === 'patient') {
            // Stay on this page (patient sign in)
        } else if (role === 'doctor') {
    ...
    return (
        <>
            <RoleModal show={showRoleModal} onSelect={handleRoleSelect} />
            {!showRoleModal && (
                <div className="auth-signin-wrapper">
                    <div className="auth-signin-card">
                        <div className="auth-signin-card-content">
                            ...
                            <div className="auth-signin-card-footer">
